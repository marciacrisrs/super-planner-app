...
Run the narrowest relevant tests during development and `./gradlew verifyCi` before considering a code change complete when the task is covered by that verification task.
