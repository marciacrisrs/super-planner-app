...
class ChooseNextActivity @Inject constructor() {
    ...
    operator fun invoke(
        ...
        return NextActionDecision(
            ...
            currentReasons = current?.let { reasonsFor(it, activities, context, isCurrent = true) }.orEmpty(),
            nextReasons = next?.let { reasonsFor(it, activities, context, isCurrent = false) }.orEmpty(),
        )
    }
