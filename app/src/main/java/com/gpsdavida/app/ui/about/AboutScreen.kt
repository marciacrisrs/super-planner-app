package com.superplanner.app.ui.about
    ...
    SuperPlannerBackground {
        Column(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Text("Sobre", style = MaterialTheme.typography.headlineLarge, color = SuperPlannerColors.Ink)
                Text("Super Planner", style = MaterialTheme.typography.titleLarge, color = SuperPlannerColors.TerracottaDark)
                Text(
            ...
            SuperPlannerCard(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    Text("Projeto", style = MaterialTheme.typography.labelLarge, color = SuperPlannerColors.InkSoft)
                    Text(
